        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 animate-in fade-in duration-700 delay-100">
            {[
              ...
              <Card
                key={index}
                className="bg-white/10 backdrop-blur-xl border-2 border-white/20 hover:border-white/40 shadow-2xl hover:shadow-[0_20px_50px_rgba(139,92,246,0.4)] transition-all duration-300 hover:scale-105 group"
                ...
                return (
                  ...
                  >
                    <CardContent className="pt-6">
                      ...
                      {request.notes && (
                        <div className="mb-3 p-3 bg-green-500/20 backdrop-blur-sm rounded-lg border-l-4 border-green-400">
                      ...
                      {request.rejectionReason && (
                        <div className="mb-3 p-3 bg-red-500/20 backdrop-blur-sm rounded-lg border-l-4 border-red-400">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-white/10 backdrop-blur-xl border-white/20 focus:border-purple-400/50 focus:ring-purple-400/20 text-white"
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-2 block text-white/90">
